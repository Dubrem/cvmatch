...
export const WHATSAPP_LINK_COMPROBANTES = `https://wa.me/52${WHATSAPP_COMPROBANTES}?text=${encodeURIComponent(
  "Hola, aquí está mi comprobante de transferencia para MatchCV:"
)}`;
