      ...
      <div className="relative w-full max-w-md rounded-2xl bg-surface p-7 shadow-2xl">
        ...
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted">Paquete de 10 descargas — $99 MXN</p>
          </div>
        </div>
        ...
        {!enviado ? (
          <>
            <div className="space-y-3 rounded-xl border border-border bg-background p-4 text-sm">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-navy">$99.00 MXN</span>
              </div>
            </div>

            <form onSubmit={handleSubmit} className="mt-5">
              <label className="mb-1.5 block text-sm font-medium text-navy-light">
                Tu correo (para activar tus descargas)
              </label>
              <input
                type="email"
                required
              ...
              <p className="mt-3 text-center text-xs text-muted">
                Verificaremos tu pago y activaremos tus 10 descargas en menos de 24 horas.
              </p>
            </form>
          </>
        ) : (
          <div className="py-4 text-center">
            ...
            <p className="mt-1 text-sm text-muted">
              En cuanto confirmemos tu transferencia, activaremos tus 10 descargas y te avisaremos a{" "}
